...
class LENet(nn.Module):
    ...
    def forward(self, xA, xB):
        ...
        change_maps[0] = self.decode_conv0(change_maps[0])
        change_maps[0] = F.interpolate(change_maps[0], size=(256, 256), mode='bilinear', align_corners=False)
        change_maps[0] = self.conv_seg0(change_maps[0])


        change_maps[1] = self.decode_conv1(change_maps[1])
        change_maps[1] = F.interpolate(change_maps[1], size=(256, 256), mode='bilinear', align_corners=False)
        change_maps[1] = self.conv_seg1(change_maps[1])

        
        change_maps[2] = self.decode_conv2(change_maps[2])
        change_maps[2] = F.interpolate(change_maps[2], size=(256, 256), mode='bilinear', align_corners=False)
        change_maps[2] = self.conv_seg2(change_maps[2])
